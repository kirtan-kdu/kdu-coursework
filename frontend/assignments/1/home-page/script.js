...
const createPost = () => {
      ...
      <div class="left-post-box">
        <img src="./public/profile pic.png" alt="profile picture" />
      </div>
      <div class="right-post-box">
        <div class="post-title">
          <h3>Nitesh Gupta</h3>
          <h3 class="user-name">@nit_hck · 1s</h3>
        </div>
        <div class="post-content">
          <h3 class="post-text">
            Coffee in hand, bugs beware. Time to crush some code.<span
              class="hashtags"
              > #DeveloperLife #Coding</span
            >
          </h3>
        </div>
...
const calculateLikeCount = (likeIcon) => {
      ...
      if (likeCount) {
            ...
            const likeCountElement = document.createElement('h1');
            likeCountElement.className = 'likes-count';
            likeCountElement.textContent = 1;
            likeIcon.insertAdjacentElement('afterend', likeCountElement);
      }
